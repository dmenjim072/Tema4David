...
import ArraysPOOEnum.CatalogoAlquileres;
...
public class Empresa {
    ...
    public Empresa(String CIF, String nombre, CatalogoAlquileres catalogo1, CatalogoClientes catalogo2, CatalogoVehiculos catalogo3) {
    ...
    public void registrarClientes(Clientes x){
        ...
        this.catalogo2.añadirClientes(x);
        
    }
    
    public void registrarVehiculos(Vehiculo v){
        
        this.catalogo3.añadirVehiculo(v);
        
    }
    
    public void buscarClientes(Clientes x){//?
        
        this.catalogo2.buscarCliente(x);
        
    }
    
    public void buscarVehiculo(Vehiculo v){//?
        
        this.catalogo3.buscarVehiculo(v);
